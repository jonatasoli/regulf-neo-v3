<template>
  ...
  <div class="space-y-3">
    <div class="flex items-center justify-between">
      <h2>Dashboard</h2>
      <button @click="getDashboard" class="p-2 dashbutton">
        <svg
    ...
    <div class="flex-1">
      <ul class="pt-2 pb-4 space-y-1 text-sm">
        <li class="rounded-sm">
          <router-link :to="{ name: 'Home' }" class="flex items-center p-2 space-x-3 rounded-md">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
        ...
        <li class="rounded-sm">
          <button @click="getUser" class="flex items-center p-2 space-x-3 rounded-md buttonuser">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              class="w-5 h-5 fill-current text-gray-600"
        ...
        <li class="rounded-sm">
          <button @click="getSubscribe" class="flex items-center p-2 space-x-3 rounded-md buttonsubscribe">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              class="w-5 h-5 fill-current text-gray-600"
        ...
        <li class="rounded-sm">
          <button @click="getPaywall" class="flex items-center p-2 space-x-3 rounded-md buttonpaywall">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              class="w-5 h-5 fill-current text-gray-600"
...
import { UserIcon, TicketIcon, ViewBoardsIcon } from "@heroicons/vue/solid";
export default {
  name: "AdminDash",
  components: {UserIcon, TicketIcon, ViewBoardsIcon },
  data() {
      return {
      isDashboard: {},
      isUser: true,
  ...
  /* watch: { */
  /*   dashboardSelect() { */
  /*     this.$emit("dashboard-select", this.isDashboard); */
  /*   }, */
  /* }, */
  methods: {
    getUser() {
      ...
      this.$emit("dashboard-select", isDashboard);
    },
    getSubscribe() {
      const isDashboard = {
      isUser: false,
